...
describe('loader', function() {
  ...
  it('should convert JS numbers to Sass', function() {
  ...
  it('should convert JS strings to Sass', function() {
  ...
  it('should convert JS lists to Sass lists', function() {
  ...
  it('should convert JS objects to Sass maps', function() {
